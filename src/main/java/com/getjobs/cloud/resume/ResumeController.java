...
public class ResumeController {
    private static final String UPLOAD_KEY_PREFIX = "ai-jobpilot:api:rate:resume-upload:user:";
    ...
    public ResponseEntity<ApiResponse<ResumeApiModels.UploadPayload>> upload(
        ...
        rateLimiter.check(
                UPLOAD_KEY_PREFIX + principal.userId(),
                rateLimits.getResumeUploadLimit(),
                rateLimits.getResumeUploadWindow()
        );
