...
public class PluginService {
    public static final List<String> DEFAULT_SCOPES = List.of("device:read", "tasks:read", "tasks:write");
    ...
    /** Create a one-time bind code for the current Web user. */
    public PluginModels.BindCodeResult createBindCode(UUID userId, String idempotencyKey) {
        ...
        try {
            return bindCodes.create(userId, keyHash);
